...
object GoogleVsApple {
  ...
  val apple = List("ios", "iOS", "iphone", "iPhone", "ipad", "iPad")
    ...
    lazy val googleTweets: TweetSet = TweetReader.allTweets.filter(e => google.exists(tag => e.text.contains(tag)))
    lazy val appleTweets: TweetSet = TweetReader.allTweets.filter(e => google.exists(tag => e.text.contains(tag)))
